...
if __name__ == "__main__":
    ...
    for rgb_path in tqdm(rgb_filename_list, desc="stereo generation DPT", leave=True):
        print('image is ', rgb_path)
        subprocess.run(["python","img2stereo.py","--img_path",rgb_path, "--depthmodel_path","midas_models/dpt_hybrid-midas-501f0c75.pt"])